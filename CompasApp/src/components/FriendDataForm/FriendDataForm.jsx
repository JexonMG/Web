  ...
  return(
    <div className="friend-data-form-wrapper" >
      <div className='friend-data-form-text-fields'  >
       ...
       <TextField  className="textfield-wrapper" InputProps={{className: 'textfield-input',}} InputLabelProps={{className: 'textfield-label',}} id="outlined-basic" label="Usuario de Github" variant="outlined" value={picture} onChange={(e) => setPicture(e.target.value)} />
      </div>
      <FormGroup>
